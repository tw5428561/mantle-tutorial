...
task("l1721owner", "get l1 token owner")
    .addParam("token", "OVM_L1ERC721Gateway address")
    .addParam("tokenid", "tokenid")
    .setAction(async (taskArgs, hre) => {
        const tokenFactory = await hre.ethers.getContractFactory('ExampleToken')
...
task("l2721owner", "get l2 token owner")
...
/**
 * 确认l2账户
 * hh l2721balances --token 0xedc24B777C8b90A814d1F10DCf26EF0e7d577c39 --to 0xD6f15EAC1Cb3B4131Ab4899a52E711e19DEeA73f --tokenid 2 --network opl2
 */
...
/**
 * 确认l1账户
 * hh l1721balances --token 0xedc24B777C8b90A814d1F10DCf26EF0e7d577c39 --to 0xD6f15EAC1Cb3B4131Ab4899a52E711e19DEeA73f --tokenid 1 --network opl1
 */
task("l1721balances", "确认l1账号信息")
    .addParam("token", "ExampleToken address")
    .addParam("to", "接受者钱包地址")
    .setAction(async (taskArgs, hre) => {
            const tokenFactory = await hre.ethers.getContractFactory('ExampleToken')
            const token = await tokenFactory.attach(taskArgs.token)
...
/**
 * hh withdraw721l1 --address 0xedc24B777C8b90A814d1F10DCf26EF0e7d577c39 --to 0xD6f15EAC1Cb3B4131Ab4899a52E711e19DEeA73f --tokenid 2 --network opl2
 */
