...
export interface OptimismUselessTokenInterface extends utils.Interface {
  functions: {
...
export interface OptimismUselessToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OptimismUselessTokenInterface;
